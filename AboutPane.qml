	...
	Item {
		...
		Text {
			...
			text: "<p>This application is provided free of charge, but also comes without any warranty. If you enjoy using this application consider making a contribution, either by contributing code or by making a donation.</p>
					...
					<p>This application uses Qt 5.7.0 under the GNU LGPL V3 Licence. In complience with this license, full source code access and/or the complete license agreement are publicly available at the code repository at https://bitbucket.org/wilcotomassen/workflo</p>"
			font {
